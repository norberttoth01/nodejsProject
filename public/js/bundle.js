...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, url, message) {
    var result;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibm9yYmVydDAxIiwiYSI6ImNrY2wxajczeTF0YWUyd2xwejZza212NTQifQ.H_qDvbTCiO_0uAhlTsEjwg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/norbert01/ckcl1t7hg08q91imovrs9z46g',
    scrollZoom: false // center: [-118.377815, 34.064534],
    // zoom: 4,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, " </p>")).addTo(map); // extends tha map bound to include the current location

    var lngLat = new mapboxgl.LngLat(loc.coordinates[0], loc.coordinates[1]);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./spinner":"spinner.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51H849YGpdHjvhUWdL76NpH54Nao0eQqn62a7swiYpJvCIxfyn1URkD8r3gYj2uLoWHchdwTA4MM39VpN1LaOOdTg00KqrzoGBb');
...
var logoutElement = document.querySelector('.nav__el--logout');
...
if (logoutElement) {
  logoutElement.addEventListener('click', _login.logout);
}
...
var createFormData = function createFormData() {
  ...
  ids.forEach(function (id) {
    data[id] = document.querySelector("#".concat(id)).value;
  });
  return data;
};
